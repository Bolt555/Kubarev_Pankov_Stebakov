...
void Speed()
{
	...
	while (f) {
		...
		switch (getch())
		{
			...
			break;
			case 10:
				if (lang == 0) {speed_choice = 1; Settings(); f = false;}
				if (lang == 1) {speed_choice = 0; Settings(); f = false;}
				if (lang == 2) {speed_choice = 2; Settings(); f = false;}
...
void Shop()
{
	...
	while (f) {
		...
		switch (getch())
		{
			...
			break;
			case 10:
				if (color_set_ == 0) { color_choice = 0; Menu(); f = false;}
				if (color_set_ == 1) { color_choice = 1; Menu(); f = false;}
				if (color_set_ == 2) { color_choice = 2; Menu(); f = false;}
				if (color_set_ == 3) { color_choice = 3; Menu(); f= false;}
				if (color_set_ == 4) { color_choice = 4; Menu(); f= false;}
				if (color_set_ == 5) { color_choice = 5; Menu(); f= false;}
				if (color_set_ == 6) { color_choice = 6; Menu(); f= false;}
				if (color_set_ == 7) { color_choice = 7; Menu(); f= false;}
				if (color_set_ == 8) { Menu(); f= false;}
			break;
		}
	}	
	getch();
